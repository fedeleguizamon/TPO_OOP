...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping(path = "api/v1/exoplanets")
public class ExoPlanetController {
    ...
    @PostMapping("")
    public ResponseEntity<?> getEncryptedMessage(@RequestBody List<String> message1, List<String> message2, List<String> message3) {
        try {
